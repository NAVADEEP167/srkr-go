...
/* =====================================================
   DRAW PEDESTRIAN START CONNECTOR
   -----------------------------------------------------
   When the user is inside a surveyed area, the first
   segment represents walking from their actual GPS
   position to the area's access point.

   This is intentionally kept separate from the surveyed
   road network.
===================================================== */
...
if (
    ...
    fullPath.push([
        currentAreaConnector.accessPoint[0],
        currentAreaConnector.accessPoint[1]
    ]);
}


/* =====================================================
   ADD SURVEYED ROAD ROUTE
===================================================== */
