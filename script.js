...
const campusLocations = {
    ...
    "canteen": {
        ...
        type: "area",
        corners: [
            [16.545471912446846, 81.49587778601526],
            [16.545685846356683, 81.49564066278873],
            [16.545498654198557, 81.49564531226376],
            [16.545670989842844, 81.49557247048828],
            [16.545497168545793, 81.49554922311313],
            [16.54532186143794, 81.49548103081268],
            [16.545298090970373, 81.49566391016388],
            [16.5452876913899, 81.49585918811515],
            [16.545301062278984, 81.49585298881509]
        ],
...
/* =========================================================
   3. VERIFIED JUNCTIONS  (unchanged)
========================================================= */

const campusJunctions = {
    "J01": [16.54296832396421, 81.49579954022994],
    "J02A": [16.54542089263142, 81.4959247440526],
    "J02B": [16.54522291396632, 81.49590865079855],
    "J03": [16.545413179184354, 81.497108939331],
    "J04": [16.5436879296032, 81.49713173810912],
    "J05": [16.542749464666652, 81.49712529079086],
    "J06": [16.543740737476785, 81.49581454760495]
};


/* =========================================================
   4. VERIFIED JUNCTION CONNECTIONS  (unchanged)
========================================================= */
...
/* =========================================================
   5. HIDDEN BUILDING ACCESS POINTS
   ---------------------------------------------------------
   Updated with the real entrance coordinates you gave.
   Blocks with more than one entrance keep all of them —
   the router picks whichever is closest to the user.
========================================================= */

const hiddenAccessPoints = {

    "s-block": [
        [16.545806272224254, 81.49602554733019],
        [16.54547629100055, 81.49634654274261]
    ],

    "badminton": [
        [16.545682682367893, 81.49589001761566]
    ],

    "canteen": [
        [16.545437742425392, 81.49586538741518]
    ],

    "civil": [
        [16.54473476124971, 81.49603608103126],
        [16.544658912034805, 81.49600657673219]
    ],

    "n-block": [
        [16.543777650950986, 81.49593543802783],
        [16.543948633818548, 81.49591129814675],
        [16.543757081573236, 81.49627876078064]
    ],

    "silver-jubilee": [
        [16.543740368952427, 81.49679508601636]
    ],

    "mech": [
        [16.54345127282248, 81.4959773921741]
    ],

    "eee": [
        [16.54365616453787, 81.49574005419697]
    ],

    "ece": [
        [16.543667323729984, 81.49695174631613]
    ],

    "it": [
        [16.54299527586789, 81.49701632277697]
    ],

    "admin": [
        [16.543051680247626, 81.4964494276069],
        [16.54323809083498, 81.49647893190598]
    ],

    "library": [
        [16.543205951095874, 81.49588750481811]
    ],

    "cse": [
        [16.543252188653657, 81.49572554262689],
        [16.54316363061288, 81.49574771434858]
    ],

    "technological-centre": [
        [16.542512860862757, 81.49704104708651]
    ],

    "open-air-auditorium": [
        [16.54302200847136, 81.49667733293947]
    ]
...
/* =========================================================
   6. HIDDEN ROAD POINTS  (unchanged)
========================================================= */

const hiddenRoadPoints = {
    "ADMIN_ROAD_A": [16.54294527234448, 81.4962203827168],
    "ADMIN_ROAD_B": [16.543087021001668, 81.49623594793118],
    "ADMIN_ROAD_C": [16.54287812820613, 81.49664286710765],
    "ADMIN_ROAD_D": [16.54302200847136, 81.49667733293947]
};


/* =========================================================
   7. HIDDEN ROUTING NODES  (unchanged)
========================================================= */

const hiddenRoutingNodes = {
    "R01": [16.545842569185258, 81.49595224473133],
    "R02": [16.545408629778628, 81.49590002701053],
    "R03": [16.545411207804133, 81.49709142286234],
    "R04": [16.542348489161306, 81.49712369543963],
    "R05": [16.542773869656802, 81.49711562729397],
    "R06": [16.542980114405395, 81.49578976238439],
    "R07": [16.543212139483423, 81.49671490950188],
    "R08": [16.542843477283537, 81.49667994754687],
    "R09": [16.543031675561217, 81.49577900485869],
    "R10": [16.545222979100505, 81.49589032028055],
    "R11": [16.545349207926304, 81.49531537467772],
    "R12": [16.545783056507968, 81.49558108170531]
};


/* =========================================================
   8. CONFIRMED HIDDEN ROAD CONNECTIONS  (unchanged)
========================================================= */
...
const hiddenRoadConnections = {
    ...
    "R07": ["R08"],
    "R09": ["ADMIN_ROAD_B"],
    "ADMIN_ROAD_A": ["ADMIN_ROAD_B"],
    "ADMIN_ROAD_B": ["ADMIN_ROAD_A", "ADMIN_ROAD_D"],
    "ADMIN_ROAD_C": ["ADMIN_ROAD_D"],
    "ADMIN_ROAD_D": ["ADMIN_ROAD_C", "ADMIN_ROAD_B"]
};


/* =========================================================
   9. S BLOCK INFORMATION  (unchanged)
========================================================= */
...
function updateRouteProgress(position) {
    ...
    if (
        ...
        nearestDistance > NAV_OFF_ROUTE_DISTANCE
    ) {
        return;
    }
...
function drawVerifiedConnections() {
    ...
    Object.entries(campusConnections).forEach(([from, connections]) => {
        connections.forEach(to => {
            const key = [from, to].sort().join("-");
            if (drawn.has(key)) return;
            drawn.add(key);
            if (!campusJunctions[from] || !campusJunctions[to]) return;

            L.polyline([campusJunctions[from], campusJunctions[to]], {
                color: "#64748b", weight: 4, opacity: 0.65, dashArray: "7 6", lineCap: "round", lineJoin: "round"
            }).addTo(map);
        });
    });
}
...
document.addEventListener("keydown", function (event) { if (event.key === "Escape") facultyOverlay.classList.remove("visible"); });

console.log("👨‍🏫 SRKR Go Faculty Finder prototype loaded.");
