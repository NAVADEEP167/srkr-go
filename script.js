 ...
 */
const NAV_DESTINATION_CONFIRM_DISTANCE = 15;
...
function refreshLiveNavigationRoute() {
    ...
    /*
     * Do not rebuild the route every GPS event.
     */
    if (
        now - lastRerouteTime <
    ...
    /*
     * First live position after navigation starts.
     */
    if (
    ...
    /*
     * How far the user has moved since the
     * previous route calculation.
     */
    const movedDistance =
        distanceBetween(
            navigationLastRouteBuildPosition,
    ...
    /*
     * Mark this position BEFORE rebuilding.
     * This prevents duplicate route builds.
     */
    navigationLastRouteBuildPosition = [
        currentUserPosition[0],
        currentUserPosition[1]
    ...
    userLocationMarker =
        L.circleMarker(
            currentUserPosition,
            {
                ...
                fillOpacity: 1,
                weight: 3,
                className: "srkr-live-location-marker"
            }
        ).addTo(map);
